      ...
      <div className="container">
        <div className="mx-auto mb-16 max-w-2xl text-center">
          ...
          <h2 className="heading-serif text-4xl sm:text-5xl">
            四步开启，
            <span className="em-italic inline-block text-rose"> 一场听写之旅</span>
          </h2>
        ...
        <div ref={ref} className="relative">
          {/* 连接线 */}
          <div className="absolute left-0 right-0 top-13 hidden border-t-2 border-dashed border-gold/25 lg:block" />
            ...
            {STEPS.map((step, i) => (
              ...
              >
                ...
                <div className="relative mb-6">
                  <div className="relative z-10 flex h-26 w-26 items-center justify-center rounded-full border-2 border-gold/40 bg-paper shadow-[0_8px_24px_-8px_rgba(184,134,11,0.3)]">
